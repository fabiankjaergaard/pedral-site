...
export const articles: Article[] = [
  {
    ...
    body: [
      ...
      "Design is at the centre of everything I do. Not design as decoration — design as a way of thinking, of solving, of feeling. Every proportion I choose, every material I select, every detail I let survive the editing process: it's all in service of something that should move the person wearing it. That's the only standard I hold myself to. Does it move you? Does it say something that couldn't be said any other way?",
      "Some designs answer yes so completely that I don't know what to do with them.",
      "There are sketches in my studio that have been sitting for years. Not because they're unfinished — but because they're too right for twenty pieces and too considered for a standard launch. Designs where the case geometry, the dial texture, the hand profile all arrived together, fully formed, like the watch already existed and I was just the one transcribing it. Those are the ones that keep me up. Those are the ones I can't shelve.",
      ...
      "Some of those designs will only ever exist on Kickstarter. They won't appear on pedral.eu. They won't be part of an edition. They live in a different space entirely — conceived for the campaign, fulfilled through it, and gone when it closes. If you only follow the site, you'll miss them. That's not accidental. Kickstarter has its own audience, its own energy. Some designs belong there and nowhere else.",
      "Kickstarter is how I handle those moments. I launched the original Okapi there in 2018 — not because I had to, but because I wanted to find out if strangers believed in the same thing I did. They did. That experience changed how I think about who a Pedral watch is for.",
      "There's also a pricing reality I can't ignore, and I'd rather say it plainly than pretend it doesn't exist. At €1,500 and up, Pedral editions are accessible — but not to everyone. I'm aware of that. I think about it more than people might expect. Some of the most genuine watch enthusiasm I've ever encountered comes from people for whom the current price point is simply out of reach — not because they don't feel the design, not because they don't understand what they're looking at, but because life doesn't always align with want. That's not a failure of taste. That's just reality.",
      "A Kickstarter campaign lets me design toward a different price point — one made possible by producing more units without abandoning what makes a Pedral a Pedral. The guilloché work, the Swiss movements, the finishing: none of that changes. What changes is the economics. Volume absorbs cost in ways that twenty pieces never can. And suddenly the person who's been following the studio for two years, who messages me asking when something more accessible is coming — they get an answer.",
      "This isn't a compromise. It's an acknowledgment that good design shouldn't only belong to people who can pay a premium for scarcity. The work doesn't become less considered because more people can hold it.",
      "Twenty pieces is a promise I make when twenty is the honest answer. For the designs that are too alive to contain — I'd rather put them in more hands than let them sit in a drawer waiting for the right moment that never comes.",
    ],
  },
  {
