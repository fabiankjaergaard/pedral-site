...
export const articles: Article[] = [
  {
    ...
    date: "March 2026",
    category: "Philosophy",
    title: "When Twenty Isn't Enough: Why Pedral Sometimes Goes Beyond the Edition Limit",
    excerpt:
      "Pedral is built on twenty-piece editions. But it wasn't always that way — and for some designs, it still isn't. Here's why an independent watchmaker sometimes breaks his own rules, and why that's the most honest thing he can do.",
    readTime: "6 min read",
    body: [
      ...
      "A Kickstarter campaign lets me design toward a different price point without dismantling what makes a Pedral a Pedral. The guilloché dials, the Swiss movements, the case finishing: none of that changes. What changes is the economics. Volume absorbs cost. And suddenly the person who has been following the studio for two years, who messages me asking when something more accessible is coming — they get an answer. That matters to me. It always has.",
